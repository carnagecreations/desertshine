  ...
  return (
    <header
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        <Link href="/" aria-label="Clean Conviction — home" className="flex items-center hover:opacity-75 transition-opacity -ml-2">
          <Image src="/clean-conviction-logo.webp" alt="Clean Conviction" width={347} height={240} priority className="h-10 w-auto md:h-12 drop-shadow-none" />
        </Link>
