  ...
  return (
    <header
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        <Link href="/" aria-label="Clean Conviction — home" className="flex items-center rounded-lg bg-[var(--paper)]/0 hover:bg-[var(--paper-light)]/40 transition-colors px-2 py-1.5 -mx-2">
